    ...
    async function fetchAllJobs() {
        try {
            ...
            for (const company of companiesList) {
                ...
                const compData = companyDetail.company ?? companyDetail;
                if (compData.jobs && compData.jobs.length > 0) {
                    for (const job of compData.jobs) {
                        allJobs.push({ ...job, company: compData });
                    }
                }
            }
                                            ...
                                            <TableCell className="text-right">
                                                <div className="flex items-center justify-end gap-1">
                                                    ...
                                                    {onViewApplicants ? (
                                                        ...
                                                        <Link href={`/company/${job.company.companyId}`}>
                                                            <Button
                                                                variant="ghost"
                                                                size="sm"
                                                                className="h-8 gap-1 text-purple-600"
